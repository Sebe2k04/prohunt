  ...
  return (
    <div className="min-h-[100vh] z-10 pt-10 px-8 lg:px-20">
      ...
      <div className="flex  justify-center pt-3">
        <h1 className="font-bold max-w-[700px] text-center text-4xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-br dark:from-white from-black  dark:via-white/70 dark:to-black to-gray-200">
      ...
      <h1 className="text-center text-sm pt-5 text-gray-600">
